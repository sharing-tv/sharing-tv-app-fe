...
const routes: Routes = [
...

  {
    path: 'rss-live-news',
    loadChildren: () =>
      import('./pages/rss-live-news/rss-live-news.module').then(
        m => m.RssLiveNewsModule
      ),
  },
...

  {
    path: 'vod-detail/:id',
    loadChildren: () =>
      import('./pages/vod/vod-detail/vod-detail.module').then(
        m => m.VodDetailModule
      ),
  },

  // Palinsesto senza guard
  {
    path: 'palinsesto',
    loadChildren: () =>
  ...
  },
  {
    path: 'cosa-facciamo',
    loadChildren: () =>
      import('./pages/cosa-facciamo/cosa-facciamo.module').then(
        m => m.CosaFacciamoPageModule
      ),
  },
  {
    path: 'comitato-scientifico',
    loadChildren: () =>
      import('./pages/comitato-scientifico/comitato-scientifico.module').then(
        m => m.ComitatoScientificoPageModule
      ),
  },
  {
    path: 'nostri-portali',
    loadChildren: () =>
      import('./pages/nostri-portali/nostri-portali.module').then(
        m => m.NostriPortaliPageModule
      ),
  },
  {
    path: 'sharing-legalita',
    loadChildren: () =>
      import('./pages/sharing-legalita/sharing-legalita.module').then(
        m => m.SharingLegalitaPageModule
      ),
  },
  {
    path: 'sharing-ia',
    loadChildren: () =>
      import('./pages/sharing-ia/sharing-ia.module').then(
        m => m.SharingIaPageModule
      ),
  },
